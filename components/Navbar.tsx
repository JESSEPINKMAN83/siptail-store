      ...
      <nav className="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
          ...
          <div className="flex items-center gap-3 h-16">
            ...
            <div className="flex-1 mx-2 sm:mx-4">
              <div className="relative">
                <input
                  type="search"
                  placeholder="Search for dog walk gear..."
            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
              ...
              {/* Account */}
              <button className="p-2 text-gray-500 hover:text-[#2d5016] transition-colors hidden sm:flex items-center" aria-label="Account">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-100 overflow-x-auto scrollbar-hide">
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex items-center gap-1 py-2 w-max min-w-full sm:w-auto sm:min-w-0 sm:justify-start">
              {[

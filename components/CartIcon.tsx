...
export default function CartIcon() {
  ...
  return (
    <Link href="/cart" className="relative flex items-center p-2 text-[#1A1A1A] hover:text-[#1B4332] transition-colors touch-manipulation min-h-[44px] min-w-[44px] justify-center" aria-label="Cart">
      ...
      {itemCount > 0 && (
        <span className="absolute -top-0.5 -right-0.5 text-white text-xs font-bold w-5 h-5 rounded-full flex items-center justify-center leading-none" style={{ background: "#1B4332" }}>

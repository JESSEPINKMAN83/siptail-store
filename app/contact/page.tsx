      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="mt-8 grid grid-cols-2 gap-4 text-center">
          <div className="border p-6" style={{ background: "#FFFFFF", borderColor: "#D4E6D4" }}>
            <p className="text-sm font-semibold mb-0.5" style={{ fontFamily: "Georgia, serif", color: "#1A1A1A" }}>
              {isHe ? "אימייל" : "Email"}
            </p>
          ...
          <div className="border p-6" style={{ background: "#FFFFFF", borderColor: "#D4E6D4" }}>
            ...
            <p className="text-xs" style={{ color: "#6B7280" }}>{isHe ? "עד 24 שעות" : "Within 24 hours"}</p>
          </div>
        </div>
      </div>
    </div>
